...
const AddDiaryModal = ({ showModal, setShowModal, reloadDiaries }) => {
    ...
    const fetchSubjects = async (classId) => {
        ...
        try {
            ...
            Swal.fire('Error', 'Unable to fetch subjects, Given Semester Does not have any Subjects. ERR No. Sub - 110', 'error');
        } finally {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire('Error', 'Failed to create notice entry.', 'error');
        }
    };
    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50" onClick={handleCloseModal}>
            <div className="bg-white p-6 h-[500px] rounded-lg shadow-lg w-full max-w-2xl overflow-y-scroll" onClick={(e) => e.stopPropagation()}>
                <h2 className="text-2xl font-semibold text-indigo-900 mb-4">Add New Notice</h2>
