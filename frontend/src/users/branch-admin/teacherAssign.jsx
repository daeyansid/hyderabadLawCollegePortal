// frontend/src/components/scheduleAndAssign/TeacherAssign.jsx
...
const TeacherAssign = () => {
    ...
    const fetchAvailableDays = async () => {
        try {
            ...
            // Swal.fire('Error', 'Failed to fetch available days.', 'error');
            setLoading(false);
        }
    };
    ...
    const handleView = (dayId) => {
        navigate(`/branch-admin/scheduleAndAssign/timeSlot/${dayId}`);
    };

    return (
        <div className="p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold text-indigo-700 mb-4">Available Days for Teacher Assignment</h2>
            {loading ? (
                    ...
                    {days.map((day) => (
                        ...
                        >
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                {/* Assign Button */}
                                <button
                                    onClick={() => handleNextStep(day._id)}
