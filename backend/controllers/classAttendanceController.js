...
exports.checkAttendanceExists = async (req, res) => {
    try {
        const { date, classId, sectionId, subjectId, teacherId } = req.query;

        if (!date || !classId || !sectionId || !subjectId || !teacherId) {
...
exports.saveAttendanceRecords = async (req, res) => {
    try {
        const { date, classId, sectionId, subjectId, teacherId, attendanceData } = req.body;
