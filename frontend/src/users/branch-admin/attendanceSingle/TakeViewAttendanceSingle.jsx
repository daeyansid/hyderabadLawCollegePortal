    ...
    const handleSaveAttendance = async () => {
        ...
        if (result.isConfirmed) {
            ...
            try {
                ...
                navigate(`/branch-admin/attendance/assigned-classes-attendance-single/slots/${branchDayId}`, {
                    state: { teacherId, teacherName }
                });
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow-md">
            ...
            <h2 className="text-2xl font-semibold mb-6 text-indigo-700">
                {actionType === 'update' ? 'Update Attendance' : 'Take Attendance'} Of Class Slot {slotName} Of {teacherName}
            </h2>
