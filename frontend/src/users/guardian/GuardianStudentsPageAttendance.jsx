// src/pages/GuardianStudentsPageAttendance.jsx
...
const GuardianStudentsPageAttendance = () => {
    ...
    const handleView = (studentId) => {
        ...
        navigate(`/guardian/select-student-attendance/${studentId}`);
    };
...
export default GuardianStudentsPageAttendance;
