// src/pages/StudentDiaryPage.jsx

import React, { useEffect, useState, useCallback } from 'react';
import { getStudentDiary } from '../../../api/studentDiaryApi';
    ...
    const fetchDiaries = async () => {
        ...
        try {
            ...
            if (Array.isArray(data) && data.length > 0) {
                ...
                setError('No diary entries found for you.');
                setDiaries([]);
                setFilteredDiaries([]);
            }
        } catch (error) {
        ...
        <div className="p-6 bg-white min-h-screen">
            ...
            {loading ? (
                <div className="flex justify-center items-center h-64">
                    ...
                    <span className="text-indigo-600 text-lg">Loading diary entries...</span>
                </div>
            ) : (
