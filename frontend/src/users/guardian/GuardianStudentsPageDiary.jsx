// src/pages/GuardianStudentsPageDiary.jsx
...
const GuardianStudentsPageDiary = () => {
    ...
    const handleView = (studentId) => {
        // Navigate to student detail page or perform an action
        navigate(`/guardian/select-student-diary/${studentId}`);
    };
        ...
        <div className="p-6 bg-white min-h-screen">
            ...
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-3xl font-bold text-indigo-700">
                    Select Your Children for Diary
                </h2>
            </div>
...
export default GuardianStudentsPageDiary;
