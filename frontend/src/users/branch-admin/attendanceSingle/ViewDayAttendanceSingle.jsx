// frontend/src/users/branch-admin/attendance/ViewDayAttendance.jsx
...
const ViewDayAttendance = () => {
    ...
    const handleView = (dayId) => {
        navigate(`/branch-admin/attendance/assigned-classes-attendance-single/slots/${dayId}`, {
            state: { teacherId: teacherId, teacherName: teacherName }
        });
    };

    return (
        <div className="p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold text-indigo-700 mb-4">Assigned Days of {teacherName}</h2>
            {loading ? (
